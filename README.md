...
see complete pricing. The former REST endpoint `GET /rest/V1/structure_data/offers/{id}` and its
supporting classes were removed in 7.0.0; use the GraphQL `structured_data` field instead.
